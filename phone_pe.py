...
def Aggre_user_plot_3(df, state):
    ...
    fig_line_1= px.line(auyqs, x= "Brands", y="Transaction_count", hover_data= "Percentage",
                        width=1000,title=f"{state.upper()} BRANDS, TRANSACTION COUNT, PERCENTAGE", markers= True)
...
def map_insur_Districts(df, state):
    ...
    with col1:
        fig_bar_1= px.bar(tacyg, x= "Transaction_amount", y="Districts", orientation= "h",
                            height=600,title= f"{state.upper()} DISTRICT AND TRANSACTION AMOUNT", color_discrete_sequence= px.colors.sequential.Mint_r)
        st.plotly_chart(fig_bar_1)

    with col2:
        fig_bar_2= px.bar(tacyg, x= "Transaction_count", y="Districts", orientation= "h",
                            height=600,title= f"{state.upper()} DISTRICT AND TRANSACTION COUNT", color_discrete_sequence= px.colors.sequential.Bluered_r)
...
def map_user_plot_2(df, quarter):
    ...
    fig_line_1= px.line(muyqg, x= "States", y= ["RegisteredUser", "AppOpens"],
                            width=1000, title=f"{df['Years'].min()} YEARS {quarter} QUARTER REGISTERED USER, APPOPENS", height= 800, markers= True)
    st.plotly_chart(fig_line_1)
...
def map_user_plot_3(df, state):
    ...
    with col1:
        fig_map_user_bar_1= px.bar(muyqs, x= "RegisteredUser", y= "Districts", orientation= "h",
                                width=1000, title= f"{state.upper()} REGISTERED USER", color_discrete_sequence= px.colors.sequential.Rainbow_r, height= 800)
        st.plotly_chart(fig_map_user_bar_1)

    with col2:
        fig_map_user_bar_2= px.bar(muyqs, x= "AppOpens", y= "Districts", orientation= "h",
                                width=1000, title= f"{state.upper()} APPOPENS", color_discrete_sequence= px.colors.sequential.Rainbow_r, height= 800)
...
def Top_insurance_plot_1(df, state):
    ...
    with col1:
        fig_top_insur_bar_1= px.bar(tiy, x= "Quarter", y= "Transaction_amount", hover_data= "Pincodes",
                                width=600, title="TRANSACTION AMOUNT", color_discrete_sequence= px.colors.sequential.GnBu_r, height= 650)
        st.plotly_chart(fig_top_insur_bar_1)

    with col2:
        fig_top_insur_bar_2= px.bar(tiy, x= "Quarter", y= "Transaction_count", hover_data= "Pincodes",
                                width=600, title="TRANSACTION COUNT", color_discrete_sequence= px.colors.sequential.Agsunset_r, height= 650)
...
if select == "Home":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\kumaram\Desktop\Phonepe-Pulse-Data-Visualization-and-Exploration\download.png"), width= 600)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\kumaram\Desktop\Phonepe-Pulse-Data-Visualization-and-Exploration\download1.jpg"), width= 600)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\kumaram\Desktop\Phonepe-Pulse-Data-Visualization-and-Exploration\download2.jpg"), width= 600)
    ...
    with tab1:
        ...
        if method == "Insurance Analysis":
            ...
            Aggre_tran_tac_Y = Aggre_Transaction_amount_count_Y(Aggre_transaction, years)
            ...
            Aggre_tran_tac_Y_Q = Aggre_Transaction_amount_count_Y_Q(Aggre_tran_tac_Y, quarters)
    ...
    with tab2:
        ...
        if method_2 == "Map Insurance":
            ...
            map_insur_tac_Y = Aggre_Transaction_amount_count_Y(map_insurance, years)
            ...
            map_insur_tac_Y_Q = Aggre_Transaction_amount_count_Y_Q(map_insur_tac_Y, quarters)

            col1,col2 = st.columns(2)
            with col1:
                states = st.selectbox("Select The State_mi_ty", map_insur_tac_Y_Q['States'].unique())
            ...
            map_tran_tac_Y = Aggre_Transaction_amount_count_Y(map_transaction, years)
            ...
            map_tran_tac_Y_Q = Aggre_Transaction_amount_count_Y_Q(map_tran_tac_Y, quarters)

            col1,col2 = st.columns(2)
            with col1:
                states = st.selectbox("Select The State_mt_ty", map_tran_tac_Y_Q['States'].unique())
            ...
            Map_user_Y_Q_S = map_user_plot_3(Map_user_Y_Q, states)
    ...
    with tab3:
        ...
        if method_3 == "Top Insurance":
            ...
            top_insur_tac_Y = Aggre_Transaction_amount_count_Y(top_insurance, years)
            ...
            top_insur_tac_Y_Q = Aggre_Transaction_amount_count_Y_Q(top_insur_tac_Y, quarters)
            ...
            top_tran_tac_Y = Aggre_Transaction_amount_count_Y(top_transaction, years)
            ...
            top_tran_tac_Y_Q = Aggre_Transaction_amount_count_Y_Q(top_tran_tac_Y, quarters)
